...
\description{
  This function computes the marginal likelihood function of 
the static parameters of the model. 
}
\usage{
LikeF(formula, data,na.action="na.omit",pz=NULL,
...
StaPar=c(0.8,-0.8,0.01,0.01,0.01,0.01),a0=0.01,b0=0.01)}
}
\value{
...
Eventm=gte_data$V2
model="PEM"
LikeF(Ytm~1,data=data.frame(Ytm,Eventm),model="PEM",StaPar=c(0.8))
